...
export default function DisplayAns() {
    ...
    const url = 'https://stackoverflowclone-project.onrender.com';
    useEffect(()=>{
    console.log(Answer)
    },[Answer])
  // Function for Submit answer
    const handlePostAns = (e, answerLength) => {
      ...
      if (User === null) {
        ...
        }else if(Award?.data?.qnAnswered >= 4){
          alert("you got earn points and badges")
       } else {
          dispatch(
            postAnswer({
              id,
      ...
      <div className='view-ans'>
        {
            ...
            {questionList.data?.filter((ans) => ans._id === id).map((ans)=> (
                ...
                <div className='view-container2'>
                 ...
                 <p style={{marginLeft:"46%"}}>{ans.upvotes.length - ans.downvotes.length}</p> 
